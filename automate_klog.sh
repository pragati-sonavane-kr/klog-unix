...
then
	...
	mkdir -p C:/Users/Bins_From_Script/$FILEDATE/Base64_files
	CUR_DIR=$PWD
...
#	echo "DATE,CORRELATION_ID,DIVISION,STORE,PAYLOAD" >nonlCwsrecords_$FILEDATE.txt
	...
	do
		...
		then
			...
			mkdir -p C:/Users/Bins_From_Script/$FILEDATE/Missing_Payload_Bins
			TLOGbinfile=`echo $TLOGBIN\_$cid\_$Division\_$Store`
			printf "\nCreating base64 file $TLOGbinfile.base64 \n\n"
		   			
			echo $base64payload > C:/Users/Bins_From_Script/$FILEDATE/Base64_files/$TLOGbinfile.base64
			
			printf "\nCreating TLOG binary file $TLOGbinfile.bin from base64 file $TLOGbinfile.base64 \n\n"
			
			base64 -d C:/Users/Bins_From_Script/$FILEDATE/Base64_files/$TLOGbinfile.base64 > C:/Users/Bins_From_Script/$FILEDATE/Missing_Payload_Bins/$TLOGbinfile.bin
			RC=$?	
			if [[ $RC -eq 0 ]]
			then
			...
			validrecords=`echo $FILEDATE\,$cid\,$Division\,$Store\,$firstfile\,Valid\,Only present in $Searchfile.`
#			echo $validrecords>>klog_report_$FILEDATE.csv
			...
			then
				mkdir -p C:/Users/Bins_From_Script/$FILEDATE/Lcws_Bins
				TLOGbinfile=`echo $TLOGBIN\_$cid\_$Division\_$Store`
			    printf "\nCreating base64 file $TLOGbinfile.base64 \n\n"
			    echo $base64payload > C:/Users/Bins_From_Script/$FILEDATE/Base64_files/$TLOGbinfile.base64
			    ...
			    base64 -d C:/Users/Bins_From_Script/$FILEDATE/Base64_files/$TLOGbinfile.base64 > C:/Users/Bins_From_Script/$FILEDATE/Lcws_Bins/$TLOGbinfile.bin
...
#				echo $LCwsrecords>>klog_report_$FILEDATE.csv
				...
				mkdir -p C:/Users/Bins_From_Script/$FILEDATE/Regular_Payload_Bins
				TLOGbinfile=`echo $TLOGBIN\_$cid\_$Division\_$Store`
			    printf "\nCreating base64 file $TLOGbinfile.base64 \n\n"
			    ...
			    base64 -d C:/Users/Bins_From_Script/$FILEDATE/Base64_files/$TLOGbinfile.base64 > C:/Users/Bins_From_Script/$FILEDATE/Regular_Payload_Bins/$TLOGbinfile.bin
...
#				echo $nonLCwsrecord>>nonLCwsrecords_$FILEDATE.txt
				nonLCwsrecords=`echo $FILEDATE\,$cid\,$Division\,$Store\,Both\,Invalid\,Regular/Large payload.`
